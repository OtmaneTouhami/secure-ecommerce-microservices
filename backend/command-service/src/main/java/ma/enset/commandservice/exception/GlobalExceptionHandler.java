...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleOrderNotFound(OrderNotFoundException ex) {
        ...
        problem.setType(URI.create("https://api.ecommerce.com/errors/order-not-found"));
    ...
    public ProblemDetail handleProductNotAvailable(ProductNotAvailableException ex) {
        ...
        problem.setType(URI.create("https://api.ecommerce.com/errors/product-not-available"));
        problem.setProperty("timestamp", Instant.now());
        return problem;
    }
    ...
    public ProblemDetail handleUnauthorizedAccess(UnauthorizedOrderAccessException ex) {
        ...
        problem.setType(URI.create("https://api.ecommerce.com/errors/unauthorized-order-access"));
        problem.setProperty("timestamp", Instant.now());
        return problem;
    }
